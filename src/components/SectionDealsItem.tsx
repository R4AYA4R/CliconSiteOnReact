...
const SectionDealsItem = ({ product }: SectionDealsItem) => {
    ...
    return (
        // если product.id > 4(если id товара больше 4,то даем такие классы,в другом случае другие,это чтобы указать определенным товарам определенные классы,в данном случае для border)
        <div className={product.id > 4 ? "deals__item deals__item-borderTop" : "deals__item"}>
